...
func (s *service) CreateExample(ctx context.Context, req *CreateExampleRequest) (*Example, error) {
...
func (s *service) GetExample(ctx context.Context, id uuid.UUID) (*Example, error) {
